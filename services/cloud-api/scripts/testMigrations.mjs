...
assert.ok(migrations.includes('020_add_pickup_documents.sql'));
const pickupDocumentsMigration = await readFile(resolve(directory, '020_add_pickup_documents.sql'), 'utf8');
