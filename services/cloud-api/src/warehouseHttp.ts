...
export function createWarehouseHttpBoundary(input: {
  ...
  return {
    origin(req: Request, res: Response, next: NextFunction): void {
      ...
      res.setHeader('Access-Control-Allow-Headers', 'Content-Type, X-Request-ID, X-Image-Sha256, X-Image-Quality-Warnings, X-Image-Quality-Override, X-Document-SHA256, X-Label-SHA256, X-Upload-Attempt, X-Retry-Of-Attempt');
