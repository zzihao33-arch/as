...
const QzSetupGuide = memo(function QzSetupGuide() {
  return (
    <div className="cmhub-qz-guide-content">
      <header className="cmhub-qz-guide-header">
        <div>
          <Title heading={5}>新电脑直打配置</Title>
          <Paragraph className="cmhub-qz-guide-description">
            依次完成以下五步。配置完成后，系统将通过 QZ Tray 直接调用本机标签打印机。
          </Paragraph>
        </div>
        <Space className="cmhub-qz-guide-actions" wrap>
          <Button type="primary" icon={<Download size={16} />} href="https://qz.io/download/?os=windows" target="_blank">
