export type LocalFirstStore = 'intercepts' | 'bolRecords' | 'printLogs' | 'payrollDrafts' | 'employeeRates' | 'cloudShipments' | 'cloudLabels' | 'cloudSync' | 'cloudPrintOutbox';
...
const openDatabase = () => new Promise<IDBDatabase>((resolve, reject) => {
  ...
  request.onupgradeneeded = () => {
    ...
    (['intercepts', 'bolRecords', 'printLogs', 'payrollDrafts', 'employeeRates', 'cloudShipments', 'cloudLabels', 'cloudSync', 'cloudPrintOutbox'] as const).forEach((storeName) => {
